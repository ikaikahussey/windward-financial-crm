...
export default function Footer() {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      await apiPost('/api/public/subscribe', { email });
    ...
    <footer className="bg-primary-dark text-white">
      <div className="container-wide mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/about" className="text-primary-light/80 hover:text-white transition-colors">About Us</a></li>
              <li><a href="/expertise" className="text-primary-light/80 hover:text-white transition-colors">Expertise</a></li>
              <li><a href="/quality-commitment" className="text-primary-light/80 hover:text-white transition-colors">Quality Commitment</a></li>
              <li><a href="/calculator" className="text-primary-light/80 hover:text-white transition-colors">Retirement Calculator</a></li>
              <li><a href="/events" className="text-primary-light/80 hover:text-white transition-colors">Events</a></li>
              <li><a href="/resources" className="text-primary-light/80 hover:text-white transition-colors">Resources</a></li>
              <li><a href="/schedule-an-appointment" className="text-primary-light/80 hover:text-white transition-colors">Schedule Appointment</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-primary/30 mt-12 pt-8 text-center text-sm text-primary-light/60">
          <p>&copy; {new Date().getFullYear()} Windward Financial | CA License # 2087268</p>
        </div>
      </div>
    </footer>
  );
