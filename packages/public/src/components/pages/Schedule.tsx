...
export default function Schedule() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setStatus('loading');
    try {
      await apiPost('/api/public/schedule', form);
      setStatus('success');
      setForm(initialForm);
    } catch {
      setStatus('error');
    ...
    <div>
      ...
      <section className="bg-primary-dark py-16 md:py-20">
        <div className="container-wide mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-heading text-4xl md:text-5xl text-white mb-4">Schedule an Appointment</h1>
            ...
            {status === 'success' ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 mt-2">
                  If you need immediate assistance, please call <a href="tel:+18888941884" className="text-primary font-semibold hover:underline">(888) 894-1884</a>.
                </p>
              </div>
            ) : (
              <>
