...
export default function EventDetail({ event }: { event: Event | null }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setStatus('loading');
    try {
      await apiPost(`/api/public/events/${id}/register`, form);
      setStatus('success');
    ...
    return (
      <div className="section-padding bg-sand">
        <div className="container-narrow mx-auto text-center">
          ...
          <a href="/events" className="btn-primary">Back to Events</a>
        </div>
      </div>
    );
  }
    ...
    <div>
      ...
      <section className="bg-primary-dark py-16 md:py-20">
        <div className="container-wide mx-auto px-4 sm:px-6 lg:px-8">
          <a href="/events" className="text-primary-light/60 hover:text-primary-light text-sm mb-4 inline-block">&larr; Back to Events</a>
