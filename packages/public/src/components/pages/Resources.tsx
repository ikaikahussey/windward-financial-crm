...
const NLG_LOGIN_URL = import.meta.env.PUBLIC_NLG_LOGIN_URL || 'https://www.nationallife.com/login';
        ...
        <div className="container-wide mx-auto">
          ...
          <div className="mt-16 card bg-primary-dark text-white text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a href="/contact" className="inline-block border-2 border-primary-light/40 text-primary-light font-semibold px-6 py-3 rounded-lg hover:bg-primary-light/10 transition-colors">
                Send a Message
              </a>
            </div>
          </div>
