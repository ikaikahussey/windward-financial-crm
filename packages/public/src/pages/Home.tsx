...
export default function Home() {
  ...
  useEffect(() => {
    api.get<Testimonial[]>('/api/public/testimonials')
      .then(setTestimonials)
      .catch(() => {
        setTestimonials([
          { id: '1', name: 'Sarah K.', role: 'Public School Teacher', quote: 'Windward Financial helped me understand my retirement options and plan for my future with confidence. Their team truly cares about Hawaii\'s educators.' },
          { id: '2', name: 'James M.', role: 'State Employee', quote: 'The personalized approach at Windward Financial made all the difference. They took the time to explain everything and find the right plan for my family.' },
          { id: '3', name: 'Linda T.', role: 'County Worker', quote: 'I wish I had found Windward Financial sooner. Their expertise in public employee benefits is unmatched.' },
        ]);
      });
  }, []);
      ...
      <section className="section-padding bg-sand">
        <div className="container-wide mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Link to="/expertise" className="card group hover:shadow-xl transition-shadow">
            ...
            <Link to="/quality-commitment" className="card group hover:shadow-xl transition-shadow">
              <div className="w-14 h-14 bg-primary-light rounded-xl flex items-center justify-center mb-5">
                <svg className="w-7 h-7 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
